...
public class PrefStore {
    ...
    /** Preference key for storing IMAP server URI. */
    static final String PREF_IMAP_SERVER_URI = "imap_server_uri";

    /** Preference key for storing security protocol (SSL or STARTTLS) */
    static final String PREF_SECURITY_PROTOCOL = "security_protocol";
    ...
    /** Preference for time sync repetition time (in hours). */
    ...
    /** Default value for {@link PrefStore#PREF_IMAP_SERVER_URI}. */
    static final String DEFAULT_IMAP_SERVER_URI = "imap.gmail.com:993";

    /** Default value for {@link PrefStore#PREF_SECURITY_PROTOCOL}. */
    static final String DEFAULT_SECURITY_PROTOCOL = "SSL";
    ...
    static boolean isLoginUsernameSet(Context ctx) {
        return getLoginUsername(ctx) != null;
    }
    
    static boolean isLoginPasswordSet(Context ctx) {
        return getLoginPassword(ctx) != null;
    }

    static boolean isImapServerUriSet(Context ctx) {
        return getImapServerUri(ctx) != null;
    }
    ...
    static String getImapServerUri(Context ctx) {
        return getSharedPreferences(ctx).getString(PREF_IMAP_SERVER_URI, DEFAULT_IMAP_SERVER_URI);
    }

    static String getSecurityProtocol(Context ctx) {
        return getSharedPreferences(ctx).getString(PREF_SECURITY_PROTOCOL,
                DEFAULT_SECURITY_PROTOCOL);
    }

    static String getSecurityProtocolForImapStore(Context ctx) {
        return getSecurityProtocol(ctx).equals(ctx.getString(R.string.ui_ssl_label)) ? "ssl"
                : "tls";
    }
    ...
    static boolean isValidImapServerUri(String imapServerUri) {
        String pattern = ".+:\\d{1,5}";
        return imapServerUri.matches(pattern);
    }
